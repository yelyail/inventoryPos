...
<div class="downdiv" style="overflow:auto !important; display: grid; grid-template-columns: repeat(3, 1fr); gap: 10px;">    
...
<!-- Cart positioned in the upper right corner -->
<div class="downdash" style="position: fixed; top: 60px; right: 10px; width: 550px; background-color: white; padding: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); z-index: 1000;">
    <div class="card-title">Cart</div>
    <!-- You can add cart items here -->
</div>
